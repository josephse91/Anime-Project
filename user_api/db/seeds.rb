...
jarret_comment_2 = ReviewComment.create({
    comment:"This may be the greatest piece of fiction, I've ever seen",
    review_id: aldane_review_2.id,
    user_id: jarret.username,
    parent: aldane_review_2.id,
    comment_type: "comment"
})

jarret_comment_2.top_comment = jarret_comment_2.id
...
aldane_reply_3 = ReviewComment.create({
    comment:"Nothing is better and nothing will be better",
    review_id: aldane_review_1.id,
    user_id: aldane.username,
    parent: serge_reply_1.id,
    comment_type: "reply",
    top_comment: jarret_comment_2.id
})
